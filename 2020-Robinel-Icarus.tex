...
\begin{figure}[!ht]
    % \includegraphics[width=.9\linewidth]{Fig_9}
...
\begin{figure}[!ht]
    % \includegraphics[width=.9\linewidth]{Fig_10}
...
\begin{figure}[!ht]
    ...
    \caption{Orthographic views derived from the RGB corrected color map (\figref{fig_10}) overlapped on ISS mosaic produced by Bland(2018). The top left image is centered at Enceladus' North Pole whereas the bottom left one is centered at Enceladus' South Pole. Images a), b) and c) show zooms of Enceladus' South Pole.}
    \label{fig:fig_11}
\end{figure}
...
\begin{landscape}
    \begin{figure*}[!ht]
        % \includegraphics[width=.9\linewidth]{Fig_S1}
...
\begin{landscape}
    \begin{figure*}[!ht]
        % \includegraphics[width=.9\linewidth]{Fig_S2}
